...
public class Codificacion {
	public static String secuenciasBytes(Map<Character, String> map, String lectura) {
		...
		//Fase 2, creacion de sub cadenas, todas deben empezar por 1 para que se pueda crear un caracter (en la descompresión)
	...
	// el .write se encargará luego de pasar dichos decimales a caracteres especiales para demostrar la 
	...
	public static void escritura(String[] arr, String lastSecuence, String ruta) throws IOException {
		...
		// Esta última en el caso de que empiece por cero, no se pasa como caracter especial sino que se pega
	...
	// Método para descomprimir el archivo en UTF-8 al original
	// String esta en UTF-8
	public static String Decodificar2(String s, Map<Character,String> map, String lasBinaryDecode) {// Secuencia última en binario para evitar los problemas
	...
	// Método que permite la lectura del archivo con los caracteres especiales resultantes
