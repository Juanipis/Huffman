...
public class CreadorArbol {
	// Método de lectura y almacenamiento del archivo
	...
	// Método de reconocimiento de caracteres y generación de tabla de frecuencias
	public static PriorityQueue<Diccionario> reconocimientoCaracteres(String s) { //El archivo.txt ya
		...
		for (int i = 0; i < caracteresMensaje.length; i++) { // Se recorre el arreglo de caracteres y se agrega a la
			...
			// añada al ArrayList de tipo diccionario, en caso de que ya se encuentre, ponemos el encontrado en
			// true.
